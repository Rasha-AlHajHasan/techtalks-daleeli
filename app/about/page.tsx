...
const features = [
  {
    ...
    desc: "One place for all information.",
  },
  {
    icon: FileSignature,
    title: "Simple Navigation",
    desc: "Easy and intuitive structure.",
  },
  {
    icon: Fingerprint,
    title: "User-Focused",
    desc: "Designed around real needs.",
  },
];
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center py-16 lg:py-20">
          <div className="flex-1 px-8 mb-10 lg:mb-0 lg:pr-12">
            ...
            <p className="text-base text-slate-600 leading-relaxed max-w-lg mb-5">
              Daleeli is a platform designed to simplify how people search for
              and access syndicate-related information. Instead of dealing with
              scattered data and unclear sources, users can find everything
              through one organized and user-friendly experience.
            </p>

            <p className="text-base text-slate-600 leading-relaxed max-w-lg mb-7">
              Our mission is to make information easier to reach, easier to
              understand, and more useful in everyday life. We believe
              technology should remove complexity, not add it — and that is
              exactly what Daleeli aims to do.
            </p>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link
                href="/register"
                className="bg-slate-100 text-slate-900 px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-slate-200 transition-colors"
              >
                Register Now
              </Link>
            </div>
      ...
      <section className="bg-white py-16 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-8 text-center">
          ...
          <p className="text-base text-slate-600 max-w-2xl mx-auto">
            ...
            real-world problems while growing our experience in creating
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="max-w-xl">
            ...
            <p className="text-slate-600 text-sm">
              Reach out for support or any inquiries.
            </p>
          </div>

          <a
            href="mailto:support@daleeli.com"
            className="flex items-center gap-2 bg-blue-700 text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-blue-800 transition-colors"
          >
            <Mail size={16} />
            Contact Us
          </a>
